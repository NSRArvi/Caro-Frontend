...
//     final String consignmentId = "#${order.orderId}";
...
//                   Text(order.receiverInformation.receiverPhone),
//                   5.verticalSpace,
//                   Text(order.receiverInformation.name),
//                 ],
//               ),
//             ),
...
//                   _infoRow("Parcel type", order.package),
//                   _infoRow("Weight", "${order.weight} ${order.weightType}"),
//                   _infoRow(
//                     "Delivery Charge",
//                     "\$${order.orderAttempts[0].fare}",
//                     boldValue: true,
//                   ),
//                 ],
//               ),
