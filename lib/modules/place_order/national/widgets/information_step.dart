...
class InformationStep extends StatefulWidget {
  final PlacingOrderController controller;
  const InformationStep({super.key, required this.controller});
...
class _InformationStepState extends State<InformationStep> {
              ...
              widget.controller.selectedPackage.value == null
                  ...
                  : Column(
                      ...
                      children: [
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        widget.controller.selectedPackage.value!['sort_description'],
                        ...
                        //     width: double.infinity,
                        //     // height: 45.h,
                        //     padding: EdgeInsets.only(left: 15,top: 12,bottom: 12,right: 10),
                        //     decoration: BoxDecoration(
                        //       color: Colors.white,
                        //       // border: Border.all(
                        ...
                        Form(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              //   ],
                              //   onChanged: (val) {
                              //     controller.prodWeight.value = double.parse(
                              //       controller.productWeightController.text
                              //           .trim(),
                              //     );
                              //   },
                              //   validator: (val) {
                              ...
                              TextFormField(
                                ...
                                validator: (val) {
                                  ...
                                  if (weight < 15) {
                                    return 'Delivery charge cannot be less then 15.';
                                  }
                                  if (weight > 1000) {
                                    return 'Delivery charge over 1000 not be allowed.';
                                  }
  ...
  //             countryCode.value = code.dialCode ?? '+1';
  //           },
  //           initialSelection: 'BD', // Bangladesh default
  //           favorite: const ['+880', '+91', '+1'],
